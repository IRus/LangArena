...
main :: proc() {
	...
	benchmark.register_benchmark_factory(
		"Brainfuck::Recursion",
	...
	benchmark.register_benchmark_factory(
		...
		benchmark.create_calculatorinterpreter,
	)
	benchmark.register_benchmark_factory("Etc::GameOfLife", benchmark.create_gameoflife)
	benchmark.register_benchmark_factory("Maze::Generator", benchmark.create_maze_generator)
	benchmark.register_benchmark_factory("Maze::BFS", benchmark.create_maze_bfs)
	benchmark.register_benchmark_factory("Maze::AStar", benchmark.create_maze_astar)
	...
	_ = os.write_entire_file("/tmp/recompile_marker", transmute([]u8)data)
}
