...
if [ ! -d "deps/simdjson" ]; then
    ...
    wget https://github.com/simdjson/simdjson/releases/download/v4.6.1/simdjson.h -O deps/simdjson/simdjson.h
    wget https://github.com/simdjson/simdjson/releases/download/v4.6.1/simdjson.cpp -O deps/simdjson/simdjson.cpp
fi
