...
public class BWTEncode : CompressBenchmark
{
    ...
    public override string TypeName => "Compress::BWTEncode";
}
...
public class BWTDecode : CompressBenchmark
{
    ...
    public override string TypeName => "Compress::BWTDecode";
}
...
public class HuffEncode : CompressBenchmark
{
    ...
    public override uint Checksum => resultVal;
    public override string TypeName => "Compress::HuffEncode";
}
...
public class HuffDecode : CompressBenchmark
{
    ...
    public override string TypeName => "Compress::HuffDecode";
}
...
public class ArithEncode : CompressBenchmark
{
    ...
    public override uint Checksum => resultVal;
    public override string TypeName => "Compress::ArithEncode";
}
...
public class ArithDecode : CompressBenchmark
{
    ...
    public override string TypeName => "Compress::ArithDecode";
}
...
public class LZWEncode : CompressBenchmark
{
    ...
    public override uint Checksum => resultVal;
    public override string TypeName => "Compress::LZWEncode";
}
...
public class LZWDecode : CompressBenchmark
{
    ...
    public override string TypeName => "Compress::LZWDecode";
}